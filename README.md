...
<p align="left">
  <img alt="GitHub User's stars" src="https://img.shields.io/github/stars/SmugglerSMR?style=social">
  <img alt="GitHub followers" src="https://img.shields.io/github/followers/SmugglerSMR?style=social">
</p>
...
|2015-2019|__Bachelor of Engineering (BEng) (Honours)__<br> major in *Computer and Software Systems (CSS)*|[Tank Commander Mixed Reality Simulation using Unity Game Engine and TensorFlow](https://github.com/SmugglerSMR/Mixed_Reaility_Tank_Commander_LaTeX/releases/tag/final)|
...
<!--|2017| Toy Robot interactive VI | Implemented small Virtual Intelegence (VI) for company robot to interact with children at MultiCat. Discovered ways to recognise faces, object and voices. Established interaction to fir physiologists' needs. | ![Python](https://img.shields.io/badge/-Python-black?style=flat-square&logo=python) |-->
<!--|2018| Laravel | | |-->
<!-- 
...
% 	%%%%%%%%%%%%%
% 	\textsc{2015-2017} & Freelances Job, \emph{Test Development and Personal Project}\\&\footnotesize{Primary job as Test Developer for Web Pages, databases and Extensions. Most of the time using \textit{Selenium}. Simultaneously,}
-->
...
<!--
### 🛠️ Utilised Hardware
Coral TPU processors

CUDA Supported Graphical Processors

Balencers controller, charge estimation.
